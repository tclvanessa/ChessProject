    ...
    public static void main(String[] args) throws FileNotFoundException, OutOfBoardException, IllegalChessMoveException {
        ...
        try {
            while (scan.hasNextLine()) {
                ...
                if (lineSegment[0].equals("pawn") || lineSegment[0].equals("rook") || lineSegment[0].equals("knight") || lineSegment[0].equals("bishop") || lineSegment[0].equals("queen") || lineSegment[0].equals("king")) {
                ...
                // the moving part
                    ...
                    else if (board.getSpace(theCol, theRow).getName().equals("Q")) {
                        name = "queen";
                    }
                    else if (board.getSpace(theCol, theRow).getName().equals("K")) {
                        name = "king";
                    }
                    ...
                    else if (board.getSpace(nextMoveCol, nextMoveRow) != null && board.getSpace(theCol, theRow) != null) {
                        if (board.getSpace(theCol, theRow).validMove(nextMoveCol, nextMoveRow)) {
                            board.setPiece(name, nextMoveCol, nextMoveRow);
                            System.out.println("\n" + name.toUpperCase() + ": (" + theCol + ", " + theRow + ") (" + nextMoveCol + ", " + nextMoveRow + ")");
                            System.out.println("Moved! (" + theCol + ", " + theRow + ") (" + nextMoveCol + ", " + nextMoveRow + ")");
